...
def main():
    ...
    # 인벤토리 파일 읽기
    print('=== 화성 기지 인벤토리 분석 ===')
    header, inventory_list = read_inventory_file('./project1/No2/Mars_Base_Inventory_List.csv')
    ...
    if inventory_list:
        ...
        # 위험 목록 CSV 저장
        save_to_csv(header, dangerous_items, './project1/No2/Mars_Base_Inventory_danger.csv')
